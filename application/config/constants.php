...
define('comp_name','RRKResort Admin');
...
define('PAGE_URL','https://www.xyz.com/products/');
define('ABS_PATH','home3/rgycsmor/public_html/');
define('UP_FILEPATH','https://www.abc.com/products/admin/');
