                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <?php if ($page_title == 'Profile') { ?>
                                <p><i class="icofont-key"></i> <b>2FA (Two-Factor Authentication):</b> <?php echo (isset($user_data) && $user_data['twofa_enabled'] == 1) ? '<i class="icofont-tick-mark" style="color:green;"></i>Enabled' : '<i class="icofont-close-squared-alt" style="color:red;"></i>Not Enabled! <a href="' . base_admin_url('enable2fa') . '">Enable Now</a>'; ?> </p>
                            <?php } ?>
                        </div>
                    </div>
                </div>
